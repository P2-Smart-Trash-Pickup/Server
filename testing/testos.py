...
for val in not_found:
    print(val)
out_obj["Tirsdag (Lige uger)"].append({"adress": "Klosterholmsgade 29, 9240 Nibe", "lon": 9.631236, "lat": 56.981334, "max_fill": 3000})
out_obj["Mandag (Lige uger)"].append({"adress": "Klosterholmsgade 29, 9240 Nibe", "lon": 9.631236, "lat": 56.981334, "max_fill": 3000})
print(len(out_obj))
